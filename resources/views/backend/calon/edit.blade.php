              ...
              <form method="post" action="#" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('alamat_ortu') is-invalid @enderror" id="alamat_ortu"  name="alamat_ortu" required value="{{ old('alamat_ortu') }}" placeholder="Masukkan Alamat Orang Tua">
                    @error('alamat_ortu')
                    <div class="invalid-feedback">  
                        {{ $message }}
                    </div>
